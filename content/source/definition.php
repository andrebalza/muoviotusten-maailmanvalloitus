...
return [
	...
	'tracks' => [
		[
			...
			'introDescription' => [
				'easy' => [
					'fi' => 'Petpetit syntyivät PET-muovista. PET-muovia käytetään juomapulloissa, ruokapakkauksissa ja vaatekuiduissa.',
					'en' => 'Petpetit were born from PET plastic. PET plastic is used in drink bottles, food packaging, and clothing fibers.',
				],
				'hard' => [
					'fi' => 'Petpetit syntyivät PET-muovista. PET-muovia käytetään juomapulloissa, ruokapakkauksissa ja vaatekuiduissa.',
					'en' => 'Petpetit were born from PET plastic. PET plastic is used in drink bottles, food packaging, and clothing fibers.',
		...
		[
			...
			'introDescription' => [
				'easy' => [
					'fi' => 'Petenkeetit syntyivät HDPE- ja LDPE-muoveista. HDPE- ja LDPE-muoveja käytetään esimerkiksi pulloissa, pusseissa, kalvoissa ja kääreissä. HDPE on yleensä vahvempaa ja jäykempää, kun taas LDPE on pehmeämpää ja joustavampaa.',
					'en' => 'Petenkeetit were born from HDPE and LDPE plastics. HDPE and LDPE plastics are used, for example, in bottles, bags, films, and wrappers. HDPE is usually stronger and more rigid, while LDPE is softer and more flexible.',
				],
				'hard' => [
					'fi' => 'Petenkeetit syntyivät HDPE- ja LDPE-muoveista. HDPE- ja LDPE-muoveja käytetään esimerkiksi pulloissa, pusseissa, kalvoissa ja kääreissä. HDPE on yleensä vahvempaa ja jäykempää, kun taas LDPE on pehmeämpää ja joustavampaa.',
					'en' => 'Petenkeetit were born from HDPE and LDPE plastics. HDPE and LDPE plastics are used, for example, in bottles, bags, films, and wrappers. HDPE is usually stronger and more rigid, while LDPE is softer and more flexible.',
		...
		[
			...
			'introDescription' => [
				'easy' => [
					'fi' => 'Propellukset syntyivät PP-muovista. PP-muovia käytetään ruokapakkauksissa, rasioissa, korkeissa, leluissa ja kalusteissa.',
					'en' => 'Propellukset were born from PP plastic. PP plastic is used in food packaging, containers, caps, toys, and furniture.',
				],
				'hard' => [
					'fi' => 'Propellukset syntyivät PP-muovista. PP-muovia käytetään ruokapakkauksissa, rasioissa, korkeissa, leluissa ja kalusteissa.',
					'en' => 'Propellukset were born from PP plastic. PP plastic is used in food packaging, containers, caps, toys, and furniture.',
		...
		[
			...
			'introDescription' => [
				'easy' => [
					'fi' => 'Styrintit syntyivät PS-muovista. PS-muovia käytetään styroksipakkauksissa, kertakäyttöastioissa, eristeissä ja suojapakkauksissa.',
					'en' => 'Styrintit were born from PS plastic. PS plastic is used in styrofoam packaging, disposable tableware, insulation, and protective packaging.',
				],
				'hard' => [
					'fi' => 'Styrintit syntyivät PS-muovista. PS-muovia käytetään styroksipakkauksissa, kertakäyttöastioissa, eristeissä ja suojapakkauksissa.',
					'en' => 'Styrintit were born from PS plastic. PS plastic is used in styrofoam packaging, disposable tableware, insulation, and protective packaging.',
		...
		[
			...
			'introDescription' => [
				'easy' => [
					'fi' => 'Zekazotkuzet syntyivät muoveista, joissa on kierrätysmerkintä Other 7 (muut muovit). Tähän ryhmään kuuluu monenlaisia muoveja, joita käytetään esimerkiksi elektroniikassa, autoissa ja erilaisissa erikoistuotteissa.',
					'en' => 'Zekazotkuzet were born from plastics marked with the recycling label Other 7 (other plastics). This group includes many kinds of plastics used, for example, in electronics, cars, and various specialty products.',
				],
				'hard' => [
					'fi' => 'Zekazotkuzet syntyivät muoveista, joissa on kierrätysmerkintä Other 7 (muut muovit). Tähän ryhmään kuuluu monenlaisia muoveja, joita käytetään esimerkiksi elektroniikassa, autoissa ja erilaisissa erikoistuotteissa.',
					'en' => 'Zekazotkuzet were born from plastics marked with the recycling label Other 7 (other plastics). This group includes many kinds of plastics used, for example, in electronics, cars, and various specialty products.',
	...
	'achievementByPartCount' => [
		0 => [
			'fi' => 'Otuksenne ei saanut yhtään ruumiinosaa, mutta voitte silti rakentaa sen mielikuvituksenne mukaan!',
					...
					[
						...
						'options' => [
							...
							[
								'id' => 'b',
								'text' => [
									'fi' => 'Muovi on elollista materiaalia, joka kehittyy ajan kuluessa',
									'en' => 'Plastic is a living material that develops over time',
								],
							],
							[
								'id' => 'c',
								'text' => [
									...
									'en' => 'Through evolution, plastics have learned to eat plants',
								],
							],
							[
								'id' => 'd',
						...
						'tip' => [
							'fi' => 'Muovi on elotonta materiaalia.',
							'en' => 'Plastic itself is non-living material.',
						],
						'explanation' => [
							'fi' => 'Muovi ei ole elollista eikä se kehity itsestään. Jotkut bakteerit ovat kuitenkin evoluution myötä oppineet hajottamaan muovia ja käyttämään sitä energianlähteenä.',
							'en' => 'Plastic is not living and does not evolve by itself. However, some bacteria have evolved to break plastic down and use it as an energy source.',
						],
					],
				],
			],
